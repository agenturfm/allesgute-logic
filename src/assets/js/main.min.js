...
jQuery(document).ready((function(e){e(window).width()<1200&&e(".tooltip").on("click",(function(){e(this).toggleClass("show")})),e(".size-item").on("click",(function(){e(this).parents(".sizes-list").find(".size-item").not(e(this)).removeClass("selected"),e(this).addClass("selected");let s=e(this).attr("data-size");e(".section-left .canvas-wrapper").removeClass("normal medium large"),e(".section-left .canvas-wrapper").addClass(s)})),e(".checkbox").on("click",(function(){e(this).toggleClass("checked")})),new Swiper(e(".comments-list .swiper-container"),{slidesPerView:2,spaceBetween:30,speed:300,preloadImages:!0,parallax:!0,threshold:1,lazy:{loadPrevNext:!0},slidesPerGroup:2,breakpoints:{1024:{slidesPerView:3,spaceBetween:0,slidesPerGroup:2}},navigation:{nextEl:".comments-list-nav .slide-next",prevEl:".comments-list-nav .slide-prev"}})}));