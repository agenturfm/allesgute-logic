...
export class AppComponent implements OnInit {
    ...
    public headerImgs: HeaderBgDefinitions[] = [
        // Geburtstag
        { type: 'type-2', textColor: '#000', tiles:
        ...
        // Hochzeit
        { type: 'type-3', textColor: '#000', tiles:
        ...
        // Geburt
        { type: 'type-1', textColor: '#fff', tiles:
        ...
        // Kommunion
        { type: 'type-4', textColor: '#000', tiles:
        ...
        // Weihnachten
        { type: 'type-5', textColor: '#fff', tiles:
